(function ($) {
	...
	if($('.active-sticky-header').length){
		...
		setHeaderHeight();
		$("header .header-sticky").addClass("active").removeClass("hide");
...
fetch("header.html")
  ...
  .then(data => {
    ...
    if (window.KaramSetuI18n && typeof window.KaramSetuI18n.updateActiveLang === "function") {
      window.KaramSetuI18n.updateActiveLang();
    }
  });